...
while($userRow=mysqli_fetch_assoc($resultUsers)){
    ...
    <img src='img/{$userRow["picture"]}' class='card-img-top' alt='...'>
    <div class='card-body'>
      <h5 class='card-title'>{$userRow["first_name"]}</h5>
      <p class='card-text'>{$userRow["email"]}</p>
      <a href='update.php?x={$userRow["id"]}' class='btn btn-warning'>Update</a>
    </div>
    </div>
    </div>";
}
   ...
   <nav class="navbar navbar-expand-lg bg-body-tertiary" >
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" >
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="Admin/index.php" >Animals</a>
                </li>
                <li class="nav-item">
