...
if(!isset($_SESSION["user"]) && !isset($_SESSION["adm"])){ 
   ...
   $sql= "SELECT*FROM users WHERE id = $id"; //get data by id
...
<html lang="en">
    ...
    <body>
       ...
       <div class="mb-3 mt-3">
               ...
               <input  type="text" class="form-control" id="address" aria-describedby="address" name="address" placeholder="Street, Nr" value="<?=$row["address"]?>">
            </div>
<!-- phone -->
<div class="mb-3 mt-3">
               <label for="phone" class= "form-label">Phone Number</label>
               <input  type="text" class="form-control" id="phone" aria-describedby="phone" 
name="phone" placeholder="xxxxxx" value="<?=$row["phone"]?>">
            </div>
                <div class="mb-3">
